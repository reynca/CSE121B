...
document.querySelector('#odds').innerHTML = numbers.filter((a) => a % 2 == 1)

// Step 4: Use the filter array method to find all of the even numbers of the array variable and assign the result to the HTML element with an ID of "evens"

document.querySelector('#evens').innerHTML = numbers.filter((a) => a % 2 == 0)

// Step 5: Use the reduce array method to sum the array variable elements and assign the result to the HTML element with an ID of "sumOfArray"

document.querySelector('#sumOfArray').innerHTML = numbers.reduce((a, b) => a + b)
...
let map_numbers = numbers.map(a => a * 2);
document.querySelector('#sumOfMultiplied').innerHTML = map_numbers.reduce((a, b) => a + b);
